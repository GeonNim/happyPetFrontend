...
const MyPage = ({ onLogout }) => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [reservationsResponse, inquiriesResponse] = await Promise.all([
          axios.get(`https://happypetbackend.geonnim.com/get_reserv/${userid}`, {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get(`https://happypetbackend.geonnim.com/get_inq/${userid}`, {
            headers: { Authorization: `Bearer ${token}` },
          }),
        ]);
  ...
  const handleAccountDeletion = async () => {
    ...
    if (confirmDeletion) {
      ...
      try {
        await axios.delete(`https://happypetbackend.geonnim.com/delete_account/`, {
          headers: {
