...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${secrets.REACT_APP_MY_DOMAIN}/register`, {
  ...
  return (
    ...
    <div>
      <br />
      <h2 className="font-Kr flex justify-center text-4xl font-semibold">
        회원가입
      </h2>
      <br />
      <br />
      <form onSubmit={handleSubmit}>
        <div className="w-full bg-gray-200 border-gray-500 py-3 text-xl mb-3">
        ...
        <div className="w-full bg-gray-200 border-gray-500 py-3 text-xl mb-6">
