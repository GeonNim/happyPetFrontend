      ...
      <div className='bg-white w-full rounded-lg shadow-lg'>
        <div className="flex flex-col items-center bg-[#f1f3ea] py-10 px-6 md:px-10 rounded-lg h-full font-Kr text-center">
          ...
          <h2 className='text-start font-En font-bold text-2xl md:text-4xl py-4 md:py-6'>
            <FaPaw className="inline-block text-green-600 mr-2" /> About HappyPet
          </h2>
          ...
          <div className='w-full md:w-[70%] text-start space-y-6'>
            ...
            <h4 className='font-bold text-xl md:text-2xl pb-3'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 우리의 이야기
            </h4>
            ...
            <h4 className='font-bold text-xl md:text-2xl pb-3'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 우리의 서비스
            </h4>
            ...
            <h4 className='font-bold text-xl md:text-2xl pb-3'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 신뢰할 수 있는 파트너십
            </h4>
            <p className='pb-4 md:pb-6'>해피펫은 신뢰할 수 있는 동물병원들과의 파트너십을 통해 보호자들에게 최상의 의료 서비스를 제공합니다...</p>

      
            <h4 className='font-bold text-xl md:text-2xl pb-3'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 보호자 중심의 서비스 철학
            </h4>
            <p className='pb-4 md:pb-6'>해피펫은 반려동물과 보호자 간의 유대가 그 무엇과도 비교할 수 없는 특별한 관계임을 알고 있습니다...</p>

            <h4 className='font-bold text-xl md:text-2xl pb-3'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 투명성과 안전성
            </h4>
            <p className='pb-4 md:pb-6'>해피펫은 사용자 정보의 보안을 최우선으로 생각하며, 모든 데이터는 안전하게 관리됩니다...</p>

            <h4 className='font-bold text-xl md:text-2xl pb-3'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 커뮤니티와 리소스
            </h4>
            ...
            <h4 className='font-semibold text-lg md:text-xl pb-2'>
              <FaPaw className="inline-block text-green-600 mr-2" /> 문의 및 지원
            </h4>
